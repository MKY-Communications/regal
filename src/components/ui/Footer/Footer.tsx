    ...
    return (
        <footer>
            ...
            <div className="footer-policy relative z-10">
                ...
                <p>Powered By <a href="https://mkycommunications.com" target="_blank" rel="noopener noreferrer" title="MKY Communications — digital marketing agency" className="text-white! ml-1! inline-block">MKY Communications</a> | <a href="/privacy-policy" className="text-white! ml-1! inline-block">Privacy Policy</a></p>
            </div>
        </footer>
    )
}
